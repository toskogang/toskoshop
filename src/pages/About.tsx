        ...
        <div className="max-w-3xl space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              A TechShop egy magyar tulajdonú vállalkozás, amely 2008 óta 
              szolgálja ki ügyfeleit professzionális hálózati megoldásokkal 
              és kiberbiztonsági termékekkel. Célunk, hogy a legmodernebb 
              technológiákat tegyük elérhetővé a hazai kis- és középvállalkozások, 
              valamint nagyvállalatok számára.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Misszionk, hogy minden magyar vállalkozás hozzáférjen a 
              legmegbízhatóbb IT infrastruktúrához és védelemhez. Hiszünk abban, 
              hogy a biztonságos és gyors hálózati kapcsolat alapvető joga minden 
              cégnek a modern digitális világban.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-2 text-muted-foreground">
              <p><strong>Email:</strong> info@techshop.hu</p>

...
export const products: Product[] = [
  ...
  {
    id: 16,
    name: 'Hálózat építés az alapoktól',
    price: 0,
    ...
    specifications: [
      ...
      'Logikai és fizikai hálózati topológia tervezés',
      'Eszközök kiválasztása és beszerzése',
      'Strukturált kábelezés telepítése',
      'Hálózati eszközök telepítése és konfigurálása',
  ...
  },
  {
    ...
    specifications: [
      ...
      'Korszerűsítési terv készítése',
      'Elavult eszközök cseréje',
      'Kábelrendszer frissítése (Cat6, Cat6a, optika)',
      'Wi-Fi 6 vagy újabb technológia telepítése',
      'Biztonsági rendszerek frissítése',
      'Minimális állásidő tervezése',
  ...
  },
  {
    ...
    specifications: [
      ...
      'Bővítési terv készítése',
      'Új hálózati szegmensek kialakítása',
      'További switcher és hálózati eszközök telepítése',
      'Kábelezés bővítése',
      'Meglévő rendszerrel való integráció',
      'Teljesítmény optimalizálás',
      'Terhelési tesztek és dokumentáció'
    ],
    requiresSurvey: true,
  },
];
